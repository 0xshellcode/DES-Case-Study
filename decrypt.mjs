...
const fOutput2 = f(ls2, rs2, p8PermutedKey);
console.log(`fOutput2: ${fOutput2}`);
const afterINVP = permutations(INVP, fOutput2);
console.log(`Decrypted msg: ${afterINVP}`);
//encryption done